...
Committed code, comments, tests, docs, and commit messages must stand alone: never cite plan- or cohort-only identifiers (`[INV-#]`, `[D#]`, `[AC-#]`, `[P#]`, `[Q#]`, `Cnn`) — those artifacts are not committed. Explain the behavior instead.
