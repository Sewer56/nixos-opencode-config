## RULE GROUP: CODE DOCUMENTATION
Read: referenced target files/ranges only. Repo search: NO broad search.

Owns: source/code-adjacent documentation coverage, placement, fidelity, examples, inline readability comments, body layout, and test summaries.
