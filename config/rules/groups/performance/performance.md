...
Owns: algorithmic regressions, N+1 work, unbounded work, workload validation, unsafe concurrency, material resource amplification, and grounded micro-optimization advisories.
