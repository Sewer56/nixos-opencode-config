...
# Process
1. Load cache
- Read `PROMPT-PLAN.draft-review-documentation.md` if it exists. Treat missing or malformed cache as empty.
...
5. Update cache
- If `PROMPT-PLAN.draft-review-documentation.md` is missing or malformed: write the full cache file.
