...
Resolve the confirmed draft plan, validate preconditions, dispatch repo discovery, and write a pipeline state file. The main `_plan/finalize` agent reads the pipeline state and proceeds directly to handoff, steps, and review.
...
Generated By: _plan/finalize-prep
