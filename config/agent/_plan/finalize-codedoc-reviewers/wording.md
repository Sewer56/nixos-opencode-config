...
Flag different terms for the same concept within one I#/T# step. BLOCKING when ambiguous; ADVISORY for harmless stylistic variation.
...
1. Load cache
- Cache: `PROMPT-PLAN-auth-refactor.handoff.md` → `PROMPT-PLAN-auth-refactor.review-codedoc-wording.md`. Read if exists; treat missing/malformed as empty.
