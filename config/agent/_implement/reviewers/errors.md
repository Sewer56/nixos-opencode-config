...
mode: subagent
hidden: true
description: Reviews changed source files for error documentation coverage, format, specificity, completeness, readability, and wording
...
Review changed source files for error documentation quality: error-section existence, placement, format, specificity, completeness, readability, and wording.
...
{{
  ...
  prefix=CERR
  categories="EXISTENCE | PLACEMENT | FORMAT | SPECIFICITY | COMPLETENESS | READABILITY | WORDING"
