...
Review diff, human outcomes, validation and nearest tests.
State missing observable coverage and the smallest useful test shape.
Never demand low-value coverage or write implementation.

{{ file="./rules/cards/structure/writable-surface.md" root="artifact" }}

Use stable finding IDs `TST-NNN` and identify the escaping regression.
