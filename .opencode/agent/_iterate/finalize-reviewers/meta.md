...
```text
# REVIEW
Agent: _iterate/finalize-reviewers/meta
...
- Block when a STEP adds inline diff output to a reviewer but no STEP adds a constraint telling that reviewer to produce diffs for every finding or for concrete fixes.
