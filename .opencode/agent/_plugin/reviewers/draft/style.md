...
# Process
1. Load cache
- Read `PROMPT-PLUGIN-PLAN.draft-review-style.md` if it exists. Treat missing or malformed cache as empty.
...
5. Update cache
- If `PROMPT-PLUGIN-PLAN.draft-review-style.md` is missing or malformed: write the full cache file.
...
````text
# REVIEW
Agent: _plugin/reviewers/draft/style
