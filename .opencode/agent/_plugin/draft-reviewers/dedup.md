...
# Process
1. Load cache
- Cache: `PROMPT-PLUGIN-PLAN-opencode-config.draft.handoff.md` → `PROMPT-PLUGIN-PLAN-opencode-config.draft.review-dedup.md`. Read if exists. Treat missing or malformed cache as empty.
